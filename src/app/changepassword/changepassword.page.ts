    ...
    else
    {
      this._ser.getStudentByUserId(this.user_id).subscribe(
        (data:Student[])=>{
              ...
              this._ser.onChangePassword(new Student(data[0].s_gr_no,data[0].s_roll_no,data[0].s_sname,data[0].s_fname,data[0].s_lname,data[0].s_gender,data[0].s_dob,data[0].s_email,data[0].s_address,data[0].s_class,data[0].s_div,data[0].s_contactno,data[0].s_category,data[0].s_bloodgroup,data[0].s_classteacher,
                this.user_password,data[0].s_profilepic,data[0].fk_u_id,)).subscribe(
                (data:Student[])=>{
